 ...
 */
@Data
public class SUConnectionBean extends SUAbstractServerBean implements Serializable {
    ...
    public void reset() {
        try {
            ...
            Logger.getLogger(SUConnectionBundleTreeNode.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
