...
public class SUEventBundleTreeNode extends SUAbstractBundleTreeNode<SUDatabaseBean> {

    private final SUDatabaseBean database;
    private final DatabaseDAOInter dao = new DatabaseDAOImpl();

    public SUEventBundleTreeNode(SUServerTree tree, SUDatabaseBean database) {
        super(tree, database);
