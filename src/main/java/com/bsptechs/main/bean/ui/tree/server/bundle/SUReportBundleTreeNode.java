...
public class SUReportBundleTreeNode extends SUAbstractBundleTreeNode<SUDatabaseBean> {

    private final SUDatabaseBean database;
    private final DatabaseDAOInter dao = new DatabaseDAOImpl();

    public SUReportBundleTreeNode(SUServerTree tree, SUDatabaseBean database) {
        super(tree, database);
