...
public class SUBackupBundleTreeNode extends SUAbstractBundleTreeNode<SUDatabaseBean> {

    private final SUDatabaseBean database;
    private final DatabaseDAOInter dao = new DatabaseDAOImpl();

    public SUBackupBundleTreeNode(SUServerTree tree, SUDatabaseBean database) {
        super(tree, database);
