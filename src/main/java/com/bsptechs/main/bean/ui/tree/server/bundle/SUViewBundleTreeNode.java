...
public class SUViewBundleTreeNode extends SUAbstractBundleTreeNode<SUDatabaseBean> {

    private final SUDatabaseBean database;
    private final DatabaseDAOInter dao = new DatabaseDAOImpl();

    public SUViewBundleTreeNode(SUServerTree tree, SUDatabaseBean database) {
        super(tree, database);
